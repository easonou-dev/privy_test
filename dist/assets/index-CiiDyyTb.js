import{i as g,a as m,x as w}from"./lit-element-CQT_gvNE.js";import{r as u}from"./class-map-BUQwRYdT.js";import{w as f,p as v,s as b,l as x}from"./index-jjtzGKAb.js";import{c as h}from"./index-SbWmiaGD.js";const e=v({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return x(e,()=>o(e))},subscribeKey(o,t){return b(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=f(y),R=g`
  :host {
    pointer-events: none;
  }
