import{i as d,a as u,x as p}from"./lit-element-CQT_gvNE.js";import{n as f,r as b}from"./class-map-BUQwRYdT.js";import{R as g,M as m}from"./index-jjtzGKAb.js";import{c as M}from"./index-SbWmiaGD.js";import{T as l}from"./index-CiiDyyTb.js";const C={interpolate(i,e,o){if(i.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const r=i[0]||0,n=i[1]||0,t=e[0]||0,s=e[1]||0;return o<r?t:o>n?s:(s-t)/(n-r)*(o-r)+t}},v=d`
  :host {
    width: 100%;
    display: block;
  }
