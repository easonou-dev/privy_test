import{i as f,a as b,x as l}from"./lit-element-CQT_gvNE.js";import{n as $,o as _,r as m}from"./class-map-BUQwRYdT.js";import{p as R,s as O,l as j,r as y,O as a,e as P}from"./index-jjtzGKAb.js";import{c as w}from"./index-SbWmiaGD.js";import{e as T,n as U}from"./ref-BAUA0BIo.js";import{R as B}from"./ConstantsUtil-Dmg8YACJ.js";const u=R({isLegalCheckboxChecked:!1}),g={state:u,subscribe(n){return j(u,()=>n(u))},subscribeKey(n,e){return O(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},E=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var v=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var s=n.length-1;s>=0;s--)(c=n[s])&&(t=(i<3?c(t):i>3?c(e,r,t):c(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let h=class extends b{constructor(){super(...arguments),this.inputElementRef=T(),this.checked=void 0}render(){return l`
    ...
    `}dispatchChangeEvent(){var e;this.dispatchEvent(new CustomEvent("checkboxChange",{detail:(e=this.inputElementRef.value)==null?void 0:e.checked,bubbles:!0,composed:!0}))}};h.styles=[y,E];v([$({type:Boolean})],h.prototype,"checked",void 0);h=v([w("wui-checkbox")],h);const L=f`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
