  ...
  return (
    <PrivyProvider
      ...
      config={{
        ...
        solanaClusters: [{name: 'mainnet-beta', rpcUrl: 'https://mainnet.helius-rpc.com/?api-key=7b73474a-082e-4823-be84-8dd53275cb7a'},{name: 'devnet', rpcUrl: 'https://api.devnet.solana.com'}],
        externalWallets: {
          solana: {
